...
def Laser_remote_v5(coordinates_name,x_name_offset,y_name_offset, letter_size):
    ...
    keyboard.add_hotkey('1', wait_press_enter)  # assign the key of number 9 to the wait_press_enter function
    keyboard.add_hotkey('2', wait_press_enter)  # assign the key of number 9 to the wait_press_enter function
