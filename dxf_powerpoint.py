...
def read_and_plot_layerv10(file_path,image_size,Left_centering,Top_centering,Axis_Limit,scale_mode,Reduce_factor,background_color,layer_color,close_image):
...
def read_and_plot_layerv11(file_path,image_size,Left_centering,Top_centering,Axis_Limit,scale_mode,Reduce_factor,background_color,layer_color,close_image):
    ### Added datum lines with full line, the idea is to use the separation of lines to tell them apart
    import ezdxf
    import pandas as pd
    import matplotlib.pyplot as plt
    from pptx import Presentation
...
file_path='70_CUT38_Tagging.dxf'     ####
...
read_and_plot_layerv10(file_path,image_size,Left_centering,Top_centering,Axis_Limit,scale_mode,Reduce_factor,background_color,layer_color,close_image)