...
def Transform_DXF_V1(Origin_path,Destination_path,Layer_prefix,line_color,material):
    import ezdxf
    import pandas as pd
    import matplotlib.pyplot as plt
    from pptx import Presentation
            ...
            for i in range(0, len(x)):  # loop through all the vertices of the splines found
                ...
                if x[i] == x_init and y[
                    ...
                    if check == 2:  # the final point of the loop
                        ...
                        # Assign Layer name
                        layer_name = Name1+'_'+str(Layer_prefix)+str(layer_qty-1)+' '+material
                        doc2.layers.new(name=layer_name)
...
Layer_prefix=26
line_color=5   # 1 red, 3 green, 5 blue
material='BX'

Transform_DXF_V1(Origin_path,Destination_path,Layer_prefix,line_color,material)
