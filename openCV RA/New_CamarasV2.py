####  This is New camaras V1 with input data check
...
def save_screenshot_and_data():
    ...
    ########...........VERIFICACION DE INFORMACION COMPLETA PARA AVANZAR.....................###############
    verify1 = user_data['ODF']!=""   # verify the user filled this data
    verify2 = user_data['Pala'] != "" # verify the user filled this data
    verify3 = user_data['Proyect'] != "" # verify the user filled this data
    verify4 = user_data['Packaging'] != "" # verify the user filled this data
    verify5 = user_data['Side'] != "" # verify the user filled this data
    verify_data = verify1 * verify2 * verify3 * verify4 * verify5
    print(verify1,verify2,verify3,verify4,verify5)
    print(verify_data)
    ######.......................................................................................
    ...
    if verify_data==1:
        ...
        status_label.config(text="FALTAN DATOS POR LLENAR")
...
def save_stiching():
    ...
    if verify_data==1:
        ...
        cosido_label.config(text="FALTAN DATOS POR LLENAR")
