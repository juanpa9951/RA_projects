...
def save_screenshot_and_data():
    ...
    csv_file_path = os.path.join(data_dir, "user_data_D.csv")
...
tk.Button(root, text="TOMAR FOTO", command=save_screenshot_and_data).grid(row=3, column=0, columnspan=2, pady=10)
...
tk.Button(root, text="TOMAR FIN COSIDO", command=save_stiching).grid(row=4, column=0, columnspan=2, pady=10)
