def scale_polygon(x_coords, y_coords, scale_factor_x,scale_factor_y): ## auxiliar function
...
def Resize_DXF(Origin_path, Destination_path, scale_factor_x,scale_factor_y):   # resize a DXF, requires all layers to be named and with color assigned
            ...
            for Layer_i in Layer_Names:  # loop through all the vertices of the splines found
                ...
                for i in range(0, len(x)):
                    if Layer_points[i] == Layer_i:
                        x_layer.append(x[i])
                        y_layer.append(y[i])
                ####.....here should go the scaling of x and y........
                x_layer_2, y_layer_2 = scale_polygon(x_layer, y_layer, scale_factor_x, scale_factor_y)
                x_layer=x_layer_2
                y_layer=y_layer_2
                ####..................................................
...
Resize_DXF(Origin_path,Destination_path,scale_factor_x,scale_factor_y)