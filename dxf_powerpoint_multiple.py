...
Top_centering = -5.0  # in inches   -4.9 -5.0--> last official
Axis_Limit = 8360  # in MM    8355,    (5mm(+)-8360-->last official)
Axis_Limit_Y=8355  # ONLY FOR V19 and following,  last official-8355
...
for name in DXF_Names:
    ...
    #print(name)
    #print(dxf_file)
    read_and_plot_layerv23(dxf_file, name, image_size, Left_centering, Top_centering, Axis_Limit, scale_mode,
...
#### V23 this is V21 with error detection
